package com.wenqi.test.mybatis.cache.test;

import com.wenqi.test.mybatis.cache.entity.StudentEntity;
import com.wenqi.test.mybatis.cache.mapper.ClassMapper;
import com.wenqi.test.mybatis.cache.mapper.StudentMapper;
...
public class StudentMapperTest {
    ...
    public void setUp() throws Exception {
        factory = new SqlSessionFactoryBuilder().build(Resources.getResourceAsReader("mybatis/cache/mybatis-config.xml"));
